...
host-unit-test:
	...
	cd /opt/gopath/src/github.com/contiv/netplugin && sudo -E PATH=$(PATH) scripts/unittests

host-sanity-test:
	@echo dev: running sanity tests...
	cd /opt/gopath/src/github.com/contiv/netplugin/scripts/python && PYTHONIOENCODING=utf-8 ./sanity.py -nodes 192.168.2.10,192.168.2.11
